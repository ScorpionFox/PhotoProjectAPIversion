...
{
    public partial class ProJULA : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TokenRefreshments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TokenRefreshments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TokenRefreshments_UserId",
                table: "TokenRefreshments",
                column: "UserId");
        }
